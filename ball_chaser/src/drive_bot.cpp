...
bool handle_safe_move_request(ball_chaser::DriveToTarget::Request& req, ball_chaser::DriveToTarget::Response& res)
{
    ...
    std::vector<float> velocities = {req.linear_x, req.angular_z}; 	
    ...
    res.msg_feedback = "Velocities set - linear x: " + std::to_string(velocities[0]) + " , angular z: " + std::to_string(velocities[1]);
